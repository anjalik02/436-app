...
class Generate extends Component {
 ...
 <h2 style={{ color: 'white', fontSize: '4em' }}> &nbsp;&nbsp;Song Generate </h2>
 <form onSubmit={this.handleSubmit}>
 <label style={{ color: 'white', fontSize: '2em' }}> 
    Theme:&nbsp;&nbsp; 
 </label>
 ...
 <p> </p>
 <input style={{width: "25vw"}} type="submit" value="Generate Ideas" />
 </form>
 <p> </p>
 {this.state.submit &&
 <span style={{ color: 'white', fontSize: '2em' }}><strong>Suggested Words: </strong>{this.state.keywords}
 <br />
